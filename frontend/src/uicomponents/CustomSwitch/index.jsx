...
function CustomSwitch({ isChecked, label }) {
    ...
    return (
        ...
        <FormControlLabel
            control={<MaterialUISwitch sx={{ m: 1, ml: 3, mr: 2.5 }} checked={isChecked} size="small" />}
            label={label || `${_.capitalize(isChecked ? VISUAL_MODES.DARK : VISUAL_MODES.LIGHT)} mode`}
        />
    )
}

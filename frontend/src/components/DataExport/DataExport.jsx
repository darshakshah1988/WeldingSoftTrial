...
import { GET_ALL_DEVICES, DEVICE_DATA, DASHBOARD_DATA, LINE_DATA } from '../../Api/apiPath';
...
export function DataExport() {
    ...
    const downloadData = async () => {
        ...
        if (novtech > 0 || GF_AC > 0 || GF_MF > 0) {
            ...
            let { data: lineData } = await getCall({ path: `${LINE_DATA}`+ `/${lineId}` })
            lineName = lineData.data[0].lineName;
